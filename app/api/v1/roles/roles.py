...
from app.schemas.system.role import RoleCreate, RoleUpdate, RoleResponse, RoleQuery, RoleUpdateMenusApis
...
async def get_role(
    ...
    return SuccessResponse(data=await role_obj.to_dict())
